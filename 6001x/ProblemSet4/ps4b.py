...
def isValidWordComp(word, hand):
    ...
    for k in wordDic:
        if not wordDic[k] == hand.get(k,None):
            return False
    return True
...
def compPlayHand(hand, wordList, n):
    ...
    while calculateHandlen(hand) > 0:
        ...
        if not compInput:
            ...
            print('"'+ compInput + '"' + ' earned ' + str(getWordScore(compInput,n)) + '. Total: ' + str(totalScore) + ' points')
            print()
...
def playGame(wordList):
    ...
    while True:
        ...
        while True:
            ...
            if userInput2 == 'u' or userInput2 == 'c':
                break
            print('Invalid command.')
            print()
        if userInput == 'n':
            ...
            if handList:
                newHand = handList[-1]
        if not handList:
            print('You have not picked a hand before')
            print()
